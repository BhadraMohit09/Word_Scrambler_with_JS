let words = [
  ...
  { word: "Quixotic", hint: "Idealistic but impractical", difficulty: "legendary" },
  { word: "Euphoria", hint: "Intense happiness", difficulty: "exclusive" },
  { word: "Limerence", hint: "Intense romantic attraction", difficulty: "legendary" },
  { word: "Susurrus", hint: "Whispering sound", difficulty: "legendary" },
  { word: "Zephyr", hint: "Gentle breeze", difficulty: "rare" },
  { word: "Soliloquy", hint: "Speech to oneself", difficulty: "exclusive" },
  { word: "Epiphany", hint: "Sudden realization", difficulty: "exclusive" },
  { word: "Labyrinth", hint: "Maze", difficulty: "rare" },
  { word: "Nefarious", hint: "Wicked", difficulty: "exclusive" },
  { word: "Obfuscate", hint: "To confuse", difficulty: "exclusive" },
  { word: "Pernicious", hint: "Harmful", difficulty: "exclusive" },
  { word: "Quagmire", hint: "Difficult situation", difficulty: "rare" },
  { word: "Renaissance", hint: "Rebirth", difficulty: "rare" },
  { word: "Sycophant", hint: "Flatterer", difficulty: "exclusive" },
  { word: "Tantamount", hint: "Equivalent", difficulty: "exclusive" },
  { word: "Ubiquitous", hint: "Present everywhere", difficulty: "exclusive" },
  { word: "Voracious", hint: "Greedy", difficulty: "exclusive" },
  { word: "Wistful", hint: "Longing", difficulty: "exclusive" },
  { word: "Xenophobia", hint: "Fear of strangers", difficulty: "legendary" },
  { word: "Yen", hint: "Desire", difficulty: "rare" },
  { word: "Zealot", hint: "Fanatic", difficulty: "exclusive" },
  { word: "Aplomb", hint: "Self-confidence", difficulty: "rare" },
  { word: "Benevolent", hint: "Kind-hearted", difficulty: "rare" },
  { word: "Cacophony", hint: "Harsh noise", difficulty: "exclusive" },
  { word: "Dichotomy", hint: "Division into two", difficulty: "exclusive" },
  { word: "Ebullient", hint: "Overflowing with enthusiasm", difficulty: "exclusive" },
  { word: "Fervent", hint: "Passionate", difficulty: "rare" },
  { word: "Garrulous", hint: "Talkative", difficulty: "rare" },
  { word: "Hapless", hint: "Unfortunate", difficulty: "rare" },
  { word: "Ineffable", hint: "Too great to be expressed", difficulty: "exclusive" },
  { word: "Juxtapose", hint: "To place side by side", difficulty: "exclusive" },
  { word: "Kaleidoscope", hint: "Optical instrument", difficulty: "rare" },
  { word: "Lugubrious", hint: "Mournful", difficulty: "exclusive" },
  { word: "Munificent", hint: "Very generous", difficulty: "exclusive" },
  { word: "Noxious", hint: "Harmful", difficulty: "exclusive" },
  { word: "Ostentatious", hint: "Showy", difficulty: "exclusive" },
  { word: "Pusillanimous", hint: "Lacking courage", difficulty: "legendary" },
  { word: "Recalcitrant", hint: "Stubbornly resistant", difficulty: "legendary" },
  { word: "Sagacious", hint: "Wise", difficulty: "rare" },
  { word: "Taciturn", hint: "Silent", difficulty: "rare" },
  { word: "Urbane", hint: "Polished and sophisticated", difficulty: "rare" },
  { word: "Venerable", hint: "Respected", difficulty: "rare" },
  { word: "Winsome", hint: "Charming", difficulty: "rare" },
  { word: "Xeric", hint: "Dry environment", difficulty: "exclusive" },
  { word: "Yonder", hint: "At a distance", difficulty: "rare" },
  { word: "Zephyrine", hint: "Gentle breeze", difficulty: "exclusive" },
  { word: "Ameliorate", hint: "To improve", difficulty: "exclusive" },
  { word: "Bellicose", hint: "Warlike", difficulty: "exclusive" },
  { word: "Celerity", hint: "Swiftness", difficulty: "rare" },
  { word: "Diaphanous", hint: "Light and delicate", difficulty: "exclusive" },
  { word: "Effulgent", hint: "Shining brightly", difficulty: "exclusive" },
  { word: "Flabbergast", hint: "Surprise greatly", difficulty: "exclusive" },
  { word: "Grandiloquent", hint: "Pompous language", difficulty: "legendary" },
  { word: "Halcyon", hint: "Calm and peaceful", difficulty: "rare" },
  { word: "Inimical", hint: "Harmful", difficulty: "exclusive" },
  { word: "Jejune", hint: "Naive or simplistic", difficulty: "rare" },
  { word: "Knavery", hint: "Dishonest behavior", difficulty: "exclusive" },
  { word: "Lachrymose", hint: "Tearful", difficulty: "exclusive" },
  { word: "Mendacious", hint: "Dishonest", difficulty: "exclusive" },
  { word: "Nefarious", hint: "Wicked", difficulty: "exclusive" },
  { word: "Obdurate", hint: "Stubborn", difficulty: "exclusive" },
  { word: "Pulchritude", hint: "Beauty", difficulty: "exclusive" },
  { word: "Quintessential", hint: "Perfect example", difficulty: "legendary" },
  { word: "Redolent", hint: "Fragrant", difficulty: "rare" },
  { word: "Soporific", hint: "Sleep-inducing", difficulty: "exclusive" },
  { word: "Truculent", hint: "Aggressive", difficulty: "exclusive" },
  { word: "Umbrage", hint: "Offense", difficulty: "exclusive" },
  { word: "Vicissitude", hint: "Change of fortune", difficulty: "exclusive" },
  { word: "Wheedle", hint: "To persuade", difficulty: "rare" },
  { word: "Xylograph", hint: "Wood engraving", difficulty: "exclusive" },
  { word: "Yokel", hint: "Rustic person", difficulty: "rare" },
  { word: "Zeugma", hint: "Figure of speech", difficulty: "exclusive" },
  { word: "Alacrity", hint: "Eagerness", difficulty: "rare" },
  { word: "Bifurcate", hint: "Divide into two", difficulty: "exclusive" },
  { word: "Cognizant", hint: "Aware", difficulty: "rare" },
  { word: "Debacle", hint: "Complete failure", difficulty: "exclusive" },
  { word: "Ennui", hint: "Boredom", difficulty: "exclusive" },
  { word: "Felicity", hint: "Great happiness", difficulty: "rare" },
  { word: "Gossamer", hint: "Delicate fabric", difficulty: "exclusive" },
  { word: "Harangue", hint: "Long speech", difficulty: "exclusive" },
  { word: "Idiosyncrasy", hint: "Unique trait", difficulty: "exclusive" },
  { word: "Jocular", hint: "Humorous", difficulty: "rare" },
  { word: "Kismet", hint: "Destiny", difficulty: "rare" },
  { word: "Lethargy", hint: "Sluggishness", difficulty: "rare" },
  { word: "Mellifluous", hint: "Sweet-sounding", difficulty: "rare" },
  { word: "Nebulous", hint: "Vague", difficulty: "exclusive" },
  { word: "Obsequious", hint: "Overly eager to please", difficulty: "exclusive" },
  { word: "Peregrinate", hint: "Travel widely", difficulty: "exclusive" },
  { word: "Quagmire", hint: "Difficult situation", difficulty: "rare" },
  { word: "Refulgent", hint: "Shining brightly", difficulty: "exclusive" },
  { word: "Sagacity", hint: "Wisdom", difficulty: "rare" },
  { word: "Trepidation", hint: "Fear", difficulty: "exclusive" },
  { word: "Ubiquity", hint: "Everywhere", difficulty: "rare" },
  { word: "Veneration", hint: "Respect", difficulty: "rare" },
  { word: "Winsome", hint: "Charming", difficulty: "rare" },
  { word: "Xanthic", hint: "Yellowish", difficulty: "exclusive" },
  { word: "Yielding", hint: "Compliant", difficulty: "rare" },
  { word: "Zenith", hint: "Peak", difficulty: "rare" }
];
